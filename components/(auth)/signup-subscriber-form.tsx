...
export function SignUpSubscriberForm({
  className,
  action,
  ...props
      ...
      <form action={onSubmit}>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-center">Abonnenten Account erstellen</h1>
          ...
          <div className="flex flex-col gap-6">
            ...
            <Button type="submit" className="w-full" disabled={pending}>
              {pending ? "Registrierung läuft…" : "Account erstellen"}
            </Button>
          </div>
