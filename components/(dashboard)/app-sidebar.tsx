...
import {
  ...
  IconListDetails, IconReport, IconSearch, IconSettings, IconUsers,
...
const data = {
  ...
  navClouds: [
    { title: "Capture", icon: IconCamera, isActive: true, url: "#", items: [
      { title: "Active Proposals", url: "#" }, { title: "Archived", url: "#" },
    ]},
          ...
          <SidebarMenuItem>
            ...
            >
              <a href="#">
                ...
                <span className="text-base font-semibold">PPP.io</span>
              </a>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
